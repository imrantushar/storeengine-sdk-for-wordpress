...
if ( ! function_exists( 'se_license_manager_register_1_dot_4_dot_0' ) && function_exists( 'add_action' ) ) { // WRCS: DEFINED_VERSION.
	...
	add_action( 'plugins_loaded', 'se_license_manager_register_1_dot_4_dot_0', 0, 0 ); // WRCS: DEFINED_VERSION.

	// phpcs:disable Generic.Functions.OpeningFunctionBraceKernighanRitchie.ContentAfterBrace
	/**
	 * Registers this version of SE_License_SDK.
	 */
	function se_license_manager_register_1_dot_4_dot_0() { // WRCS: DEFINED_VERSION.
		$versions = SE_License_SDK_Version_Manager::instance();
		$versions->register( '1.4.0', 'se_license_manager_initialize_1_dot_4_dot_0' ); // WRCS: DEFINED_VERSION.
	}
	 ...
	 */
	function se_license_manager_initialize_1_dot_4_dot_0() { // WRCS: DEFINED_VERSION.
